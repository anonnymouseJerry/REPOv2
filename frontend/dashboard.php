                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col mt-0">
                                                        <?php
                        								$query = "SELECT count(*) AS repo_count FROM repo_folder where user_id ='$user_id'";
                        								$result = $conn->query($query);
                        								$row = $result->fetch_assoc(); // Fetch the result as an associative array
                        								?>
                                                            <h5 class="card-title">Number of Repositories</h5>
                        				...
                        				<div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="col mt-0">
                                                    <?php
                        								$query = "SELECT count(*) AS repo_count FROM repo_file where user_id ='$user_id'";
                        								$result = $conn->query($query);
                        								$row = $result->fetch_assoc(); // Fetch the result as an associative array
                        								?>
                                                            <h5 class="card-title">Number of Uploaded Files</h5>
                                                        </div>
                                                        <div class="col-auto">
                                                            <div class="stat text-primary">
                                                                <i class="align-middle" data-feather="folder"></i>
    ...
    <div class="align-self-center w-100">
        ...
        <table class="table mb-0">
            <tbody>
                ...
                $sql = "
                    SELECT office_id, COUNT(*) as upload_count 
                    FROM users WHERE office_id = '$office_id'
                    GROUP BY office_id  
                ";
                $result = $conn->query($sql);
